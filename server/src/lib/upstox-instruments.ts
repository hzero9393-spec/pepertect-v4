...
const UNDERLYING_INSTRUMENT_KEYS: Record<string, string> = {
  NIFTY: NSE_INDEX_INSTRUMENT_MAP.NIFTY,
  BANKNIFTY: NSE_INDEX_INSTRUMENT_MAP.BANKNIFTY,
  FINNIFTY: NSE_INDEX_INSTRUMENT_MAP.FINNIFTY,
  SENSEX: NSE_INDEX_INSTRUMENT_MAP.SENSEX,
}
