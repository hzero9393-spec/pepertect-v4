...
const globalForOC = globalThis as unknown as { optionChainManager: OptionChainManager | undefined }

export function getOptionChainManager(): OptionChainManager {
  if (!globalForOC.optionChainManager) {
    globalForOC.optionChainManager = new OptionChainManager()
  }
  return globalForOC.optionChainManager
}